<div class="p-6 bg-white rounded-lg shadow-md">
   ...
   <div class="flex justify-between items-center mb-6">
        ...
        {{-- <a href="{{ route('admin.topics.create') }}" class="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700">
                Add New Topics
        </a> --}}
    </div>
    ...
    <div class="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center">
        <div class="bg-white p-6 rounded-lg max-w-sm mx-auto">
            ...
            <p class="text-gray-500 mb-4">Are you sure you want to delete this topic? The associated video will also be deleted.</p>
