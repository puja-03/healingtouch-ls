<div class="max-w-md mx-auto bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
    ...
    <form wire:submit.prevent="authenticate" class="space-y-5">
        ...
        <div class="flex items-center justify-between pt-4">
            <a href="{{ route('register') }}" class="text-sm text-primary-600 hover:underline">Create an account</a>
            <button type="submit"
                class="px-5 py-2.5 bg-gray-600 text-white font-medium rounded-lg shadow-md hover:shadow-lg transition duration-200">
                Login
            </button>
        </div>
    </form>
